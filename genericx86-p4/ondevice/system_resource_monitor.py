...
class Agent(NAE):
    ...
    def __init__(self):
        ...
        mm_cpu_uri = '/rest/v1/system/subsystems/system/%s?' \
        ...
        mm_mem_uri = '/rest/v1/system/subsystems/system/%s?' \
            'attributes=resource_utilization.memory' % chassis_subsys_name

        self.mm_mem_mon = Monitor(mm_mem_uri, 'Memory utilization raw')
    ...
    def action_cpu(self, event_value, threshold, time_period):
        ...
        # CoPP not supported on P4 platform
